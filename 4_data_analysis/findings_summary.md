...
| 🟧 **Medium (0.30–<0.50)**| sentiment_neu (-0.489)<br>type_token_ratio (0.372)|<br>exclamation_ratio (0.365)<br>avg_word_length (0.340)<br>financial_words (0.316)<br>reward_words (0.305) |
| 🟨 **Small (0.20–<0.30)** | url_count (0.270)<br>action_words (0.197)<br>urgency_words (0.202)<br>flesch_score (-0.227)<br>sentiment_pos (0.229)<br>email_pattern_count (-0.255) |
